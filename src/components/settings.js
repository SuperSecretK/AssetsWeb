...
export default class Settings extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Button style={{backgroundColor: "rgba(40,40,40,0.2)", borderRadius: 0, borderColor: "rgba(40,40,40,0.2)", marginLeft: "10px", marginRight: "20px"}} id='off' onClick={this.logOut}>{$s.str("logout")}</Button>
      </div>
